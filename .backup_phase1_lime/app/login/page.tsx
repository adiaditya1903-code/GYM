...
function AuthContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-[#080808] bg-grid-pattern relative">
      {/* Ambient background glow */}
      <div className="absolute w-[600px] h-[600px] bg-[#D7FF00]/[0.025] rounded-full blur-[160px] pointer-events-none" />

      {/* Brand Header */}
      <Link href="/" className="flex items-center gap-3 mb-8 group select-none">
        <div className="w-10 h-10 rounded-xl bg-[#D7FF00] flex items-center justify-center shadow-[0_0_20px_rgba(215,255,0,0.25)] group-hover:scale-105 transition-transform">
      ...
      {/* Main Container */}
      <div className="w-full max-w-xl bg-[#171717] border border-white/10 rounded-3xl p-6 sm:p-10 shadow-2xl relative z-10">

        {/* Main Tab Switcher: Sign In vs New Membership */}
        <div className="flex rounded-2xl bg-[#111111] border border-white/10 p-1.5 mb-8">
          <button
            type="button"
        ...
        {activeTab === "login" && (
          <div>
            {/* Role Switcher */}
            <div className="flex rounded-xl bg-[#111111] border border-white/10 p-1 mb-6">
              <button
                type="button"
                onClick={() => {
                  setLoginRole("member");
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#111111] border border-white/10 text-white placeholder:text-neutral-500 focus:border-[#D7FF00] focus:outline-none text-sm"
                  />
              ...
              <div className="flex items-center justify-between text-xs pt-1">
                <label className="flex items-center gap-2 text-[#A3A3A3] cursor-pointer">
                  <input type="checkbox" defaultChecked className="rounded accent-[#D7FF00]" />
                  <span>Remember session</span>
                </label>
                <span className="text-[#D7FF00] hover:underline cursor-pointer">
                  Forgot password?
                </span>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/10 text-center text-xs text-[#A3A3A3]">
              <p>
                ...
                <button
                  type="button"
                  onClick={() => setActiveTab("register")}
                  className="text-[#D7FF00] font-bold hover:underline cursor-pointer ml-1"
                >
                  Join DITO Fitness
                </button>
              </p>
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-xs font-bold uppercase tracking-wider text-[#D7FF00] font-space">
                    1. Select Tier & Billing
                  </label>
                  <div className="inline-flex items-center p-0.5 rounded-lg bg-[#111111] border border-white/10 text-[10px]">
                    <button
                      type="button"
                      onClick={() => setBillingCycle("monthly")}
                      className={`px-2 py-1 rounded-md font-bold uppercase transition-all ${
                        billingCycle === "monthly" ? "bg-[#D7FF00] text-[#080808]" : "text-[#A3A3A3]"
                      }`}
                    >
                      Monthly
                    </button>
                    <button
                      ...
                      className={`px-2 py-1 rounded-md font-bold uppercase transition-all ${
                        billingCycle === "yearly" ? "bg-[#D7FF00] text-[#080808]" : "text-[#A3A3A3]"
                      }`}
                    >
                      Annual (-17%)
                    </button>
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 rounded-2xl border text-left transition-all cursor-pointer ${
                          isSelected
                            ? "bg-[#D7FF00]/15 border-[#D7FF00] shadow-[0_0_15px_rgba(215,255,0,0.2)]"
                      ...
                      >
                        ...
                        <div className="text-xs font-bold text-[#D7FF00] mt-0.5 font-space">
                          {formatINR(price)}
                        </div>
              ...
              <div className="space-y-3">
                <label className="block text-xs font-bold uppercase tracking-wider text-[#D7FF00] font-space">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-[#111111] border border-white/10 text-white placeholder:text-neutral-500 focus:border-[#D7FF00] focus:outline-none text-xs sm:text-sm"
                    />
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-[#D7FF00] mb-2.5 font-space">
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-2 py-2 rounded-xl bg-[#111111] border border-white/10 text-white text-xs focus:border-[#D7FF00] focus:outline-none cursor-pointer"
                    >
