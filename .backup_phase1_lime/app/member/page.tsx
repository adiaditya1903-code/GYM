...
export default function MemberDashboard() {
  ...
  if (!member) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#080808] text-white text-sm">
        <div className="w-6 h-6 border-2 border-[#D7FF00] border-t-transparent rounded-full animate-spin mr-3" />
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white flex flex-col">
      {/* Top Navbar */}
      <header className="sticky top-0 z-30 bg-[#080808]/90 backdrop-blur-xl border-b border-white/10 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-[#D7FF00] flex items-center justify-center">
              <Dumbbell className="w-4 h-4 text-[#080808] rotate-45 stroke-[2.5]" />
            </div>
            <span className="text-lg font-black tracking-tight text-white font-space uppercase">
              DITO <span className="text-[#D7FF00]">PORTAL</span>
            </span>
          </Link>
          <span className="hidden sm:inline-block text-xs text-[#A3A3A3] font-mono">
            | ATHLETE PASS
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-[#D7FF00]/10 border border-[#D7FF00]/30 text-[#D7FF00] text-xs font-bold hover:bg-[#D7FF00]/20 transition-all cursor-pointer"
          >
          ...
          <Link href="/login">
            <button
              type="button"
              className="p-2 rounded-xl text-[#A3A3A3] hover:text-white hover:bg-white/5 transition-colors cursor-pointer"
              title="Sign Out"
            >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {/* Welcome Banner */}
        <div className="relative rounded-3xl bg-[#171717] border border-white/10 p-6 sm:p-8 overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#D7FF00]/[0.03] rounded-full blur-[100px] pointer-events-none" />

          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            <div>
              <div className="flex items-center gap-2.5 mb-2">
                <span className="text-xs font-bold uppercase tracking-widest text-[#D7FF00] font-space">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider bg-white/[0.05] border border-white/10 hover:border-[#D7FF00]/40 text-white transition-all cursor-pointer"
              >
                Extend Membership
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-6 border-t border-white/10">
            <div>
              <span className="text-[11px] uppercase font-bold text-[#A3A3A3] tracking-wider block mb-0.5">
                Current Tier
              </span>
              <span className="text-lg font-black text-[#D7FF00] font-space">
        ...
        {activeTab === "overview" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="p-6 sm:p-7 rounded-3xl bg-[#171717] border border-white/10">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <span className="text-xs font-bold uppercase tracking-wider text-[#D7FF00] font-space">
                      PROGRAMMED SESSION
                    </span>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    <div
                      key={idx}
                      className="p-3.5 rounded-xl bg-[#111111] border border-white/10 flex items-center justify-between text-xs"
                    >
                      <div className="flex items-center gap-3">
                        <span className="w-5 h-5 rounded-md bg-[#D7FF00]/10 text-[#D7FF00] flex items-center justify-center font-bold">
                          {idx + 1}
                        </span>
                        <span className="font-bold text-white">{ex.name}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <span className="text-[#A3A3A3] font-mono">{ex.sets}</span>
                        <span className="px-2 py-0.5 rounded bg-white/5 text-[#D7FF00] font-mono text-[11px]">
                          {ex.target}
                        </span>
                      </div>
                    </div>
                ...
                <div className="flex justify-between items-center pt-2">
                  <span className="text-xs text-[#A3A3A3]">Estimated Duration: 45 Mins</span>
                  <Link href="/#workout">
              ...
              <div className="p-6 sm:p-7 rounded-3xl bg-[#171717] border border-white/10">
                ...
                <div className="space-y-3 text-xs">
                  {[
                    ...
                    <div
                      key={idx}
                      className="p-3.5 rounded-xl bg-[#111111] border border-white/10 flex items-center justify-between"
                    >
                      <div>
                        <span className="font-bold text-white block mb-0.5">{log.title}</span>
                        <span className="text-[#A3A3A3]">{log.date}</span>
                      </div>
                      <div className="text-right">
                        <span className="text-[#D7FF00] font-mono font-bold block">{log.volume}</span>
                        <span className="text-[10px] text-[#A3A3A3] uppercase">{log.status}</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              {/* Digital Access Card */}
              <div className="p-6 rounded-3xl bg-[#171717] border border-[#D7FF00]/30 shadow-[0_0_30px_rgba(215,255,0,0.1)] text-center">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#D7FF00] block mb-3 font-space">
                ...
                <div className="w-40 h-40 mx-auto rounded-2xl bg-white p-3 flex flex-col items-center justify-center shadow-lg mb-4">
                  <div className="w-full h-full border-4 border-[#080808] rounded-lg p-1.5 flex flex-col justify-between">
                    <div className="flex justify-between">
                      <div className="w-7 h-7 bg-[#080808] rounded-sm" />
                      <div className="w-7 h-7 bg-[#080808] rounded-sm" />
                    </div>
                    <div className="flex items-center justify-center">
                      <Dumbbell className="w-6 h-6 text-[#080808]" />
                    </div>
                    <div className="flex justify-between">
                      <div className="w-7 h-7 bg-[#080808] rounded-sm" />
                      <div className="w-4 h-4 bg-[#080808] rounded-sm self-end" />
                    </div>
                  </div>
                </div>
              ...
              {/* Assigned Coach Card */}
              <div className="p-6 rounded-3xl bg-[#171717] border border-white/10">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#A3A3A3] block mb-3 font-space">
                  ASSIGNED MASTER COACH
                </span>

                <div className="flex items-center gap-3.5 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-[#D7FF00] flex items-center justify-center text-[#080808] font-black text-lg">
                    RS
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-white">{member.trainerName}</h4>
                    <p className="text-xs text-[#D7FF00]">Senior Hypertrophy Coach</p>
                  </div>
                </div>
        ...
        {activeTab === "workout" && (
          <div className="p-8 rounded-3xl bg-[#171717] border border-white/10 text-center space-y-6">
        ...
        {activeTab === "progress" && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-3xl bg-[#171717] border border-white/10">
              <span className="text-xs font-bold uppercase tracking-wider text-[#A3A3A3] block mb-1">
                Body Mass Index
              </span>
              <span className="text-4xl font-black text-[#D7FF00] font-space block mb-1">
                {member.bmi}
              </span>
              <span className="text-xs text-[#A3A3A3]">Normal Range (18.5 – 24.9)</span>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#171717] border border-white/10">
              ...
              <span className="text-xs text-[#A3A3A3]">Target: {member.targetWeightKg} kg</span>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#171717] border border-white/10">
              ...
              <span className="text-xs text-[#A3A3A3]">Standing Stature</span>
            </div>
          </div>
        )}
        ...
        {activeTab === "payments" && (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#171717] border border-white/10">
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-white/5">
                  {member.invoices.map((inv) => (
                    <tr key={inv.id} className="text-[#A3A3A3] hover:bg-white/[0.02]">
                      <td className="py-4 font-mono font-bold text-white">{inv.id}</td>
                      <td className="py-4">{inv.date}</td>
                      <td className="py-4">{inv.plan}</td>
                      <td className="py-4 font-mono font-bold text-[#D7FF00]">
                        {formatINR(inv.amount)}
                      </td>
                      <td className="py-4">
                        <span className="px-2.5 py-1 rounded-full bg-[#D7FF00]/10 text-[#D7FF00] font-bold text-[10px] uppercase">
                          {inv.status}
                        </span>
                      </td>
      ...
      >
        <div className="py-4 text-center space-y-4">
          <div className="w-48 h-48 mx-auto rounded-2xl bg-white p-4 flex flex-col items-center justify-center shadow-2xl">
            <div className="w-full h-full border-4 border-[#080808] rounded-lg p-2 flex flex-col justify-between">
              <div className="flex justify-between">
                <div className="w-8 h-8 bg-[#080808] rounded-sm" />
                <div className="w-8 h-8 bg-[#080808] rounded-sm" />
              </div>
              <div className="flex items-center justify-center">
                <Dumbbell className="w-8 h-8 text-[#080808]" />
              </div>
              <div className="flex justify-between">
                <div className="w-8 h-8 bg-[#080808] rounded-sm" />
                <div className="w-5 h-5 bg-[#080808] rounded-sm self-end" />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[#D7FF00] font-mono font-bold mt-0.5">{member.qrCodeToken}</p>
      ...
      >
        {coachSent ? (
          <div className="py-6 text-center space-y-3">
            <div className="w-12 h-12 rounded-full bg-[#D7FF00]/20 text-[#D7FF00] flex items-center justify-center mx-auto">
              <CheckCircle2 className="w-6 h-6 stroke-[2.5]" />
            </div>
            <p className="text-sm font-bold text-white">Message Dispatched</p>
            <p className="text-xs text-[#A3A3A3]">Coach will respond via portal notification within 2 hours.</p>
          </div>
        ) : (
