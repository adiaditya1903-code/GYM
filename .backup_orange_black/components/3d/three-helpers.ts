...
/**
 * Procedural DUMBBELL Mesh - Ultra realistic metallic finish with Athletic Orange ring accents
 */
...
/**
 * Procedural BARBELL Mesh with Flame Orange accent plate
 */
...
/**
 * Procedural KETTLEBELL Mesh with Flame Orange band
 */
...
/**
 * Procedural WEIGHT PLATE Mesh with Flame Orange bevels
 */
export function createProceduralWeightPlate(): THREE.Group {
  ...
  const hole = new THREE.Mesh(holeGeo, new THREE.MeshBasicMaterial({ color: 0x0A0A0C }));
