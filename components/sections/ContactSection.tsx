...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle2, Navigation, Sparkles, ExternalLink } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white font-space mb-4">
            READY TO <span className="text-[#00F08B]">START?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          {/* Left Column: Form */}
          <div className="lg:col-span-7 bg-[#0E121B] border border-white/[0.08] rounded-3xl p-6 sm:p-10 shadow-2xl">
            ...
            {submitted ? (
              <div className="py-10 text-center space-y-4">
                <div className="w-16 h-16 rounded-full bg-[#00F08B]/20 border border-[#00F08B] text-[#00F08B] flex items-center justify-center mx-auto shadow-[0_0_30px_rgba(0,240,139,0.3)]">
                ...
                <p className="text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
                  Thank you, <strong className="text-white">{formData.fullName}</strong>. Our head coach has reserved your slot for <strong className="text-[#00F08B]">{formData.preferredDate}</strong>. Confirmation SMS and digital locker pass dispatched to your contact details.
                </p>
                <div className="pt-4">
                  <Button
                    variant="outline"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#121724] border border-white/10 text-white placeholder:text-slate-500 focus:border-[#00F08B] focus:outline-none text-sm"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#121724] border border-white/10 text-white focus:border-[#00F08B] focus:outline-none text-sm cursor-pointer"
                    >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-[#0E121B] border border-white/[0.08] rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
              ...
              <div className="space-y-4 text-xs sm:text-sm text-slate-300">
                <div className="flex items-start gap-3.5">
                  <div className="w-9 h-9 rounded-xl bg-[#00F08B]/10 border border-[#00F08B]/30 flex items-center justify-center text-[#00F08B] shrink-0 mt-0.5">
                    <MapPin className="w-4 h-4" />
                  </div>
                  <div>
                    <h5 className="font-bold text-white uppercase tracking-wider text-xs mb-0.5">LOCATION</h5>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h5 className="font-bold text-white uppercase tracking-wider text-xs mb-0.5">PHONE</h5>
                    <a
                      href="tel:+916363561751"
                      className="text-white font-bold hover:text-[#00F08B] transition-colors"
                    >
                      +91 63635 61751
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h5 className="font-bold text-white uppercase tracking-wider text-xs mb-0.5">INSTAGRAM</h5>
                    <a
                      href="https://www.instagram.com/fit.dito/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#00F08B] font-bold hover:underline inline-flex items-center gap-1"
                    >
                      <span>@fit.dito</span>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h5 className="font-bold text-white uppercase tracking-wider text-xs mb-0.5">CLUB HOURS</h5>
              ...
              <div className="space-y-2 pt-2 border-t border-white/10">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                    <Navigation className="w-3.5 h-3.5 text-[#00F08B]" />
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[11px] font-bold text-[#00F08B] hover:underline flex items-center gap-1"
                  >
                    <span>Open in Maps</span>
                    <ExternalLink className="w-3 h-3" />
                  </a>
                </div>
                <div className="w-full h-44 rounded-2xl overflow-hidden border border-white/10 bg-[#08090D] relative">
                  <iframe
            ...
            <div className="p-6 rounded-3xl bg-[#0E121B] border border-white/[0.08] flex items-center justify-between">
              <div>
                <h4 className="text-sm font-bold text-white uppercase font-space">Staff Member?</h4>
                <p className="text-xs text-slate-400">Access the internal admin console and tour manager.</p>
              </div>
              <Link href="/login">
